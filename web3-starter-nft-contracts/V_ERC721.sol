...
contract ERC721_DEFAULT /* is ERC165 */ {
    ...
    function tokenURI(uint256 _tokenId) external pure returns (string memory){
        return "https://cyan-sheer-tarsier-951.mypinata.cloud/ipfs/QmWYcGTT3d12nuCZL3ZiCrSnz1vh6qs6V8Seg3LNgFVetf"; // +abi.encode(_tokenId)
    }
