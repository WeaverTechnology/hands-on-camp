...
contract ERC721 /* is ERC165 */ {
    ...
    mapping(uint256 => address) private _tokenApproval; // holder approve others
    mapping(address => mapping(address=>bool)) private _operatorApproval; // 2D array
    ...
    function transferFrom(address _from, address _to, uint256 _tokenId) external payable{
        ...
        require(msg.sender == _from 
            || msg.sender == _tokenApproval[_tokenId]
            || _operatorApproval[_from][_to] == true,  "ERC721: Invalid sender");
        unchecked {
