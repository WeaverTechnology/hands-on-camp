...
contract ERC721 /* is ERC165 */ {
    ...
    function tokenURI(uint256 _tokenId) external view returns (string memory){
        ///return "https://cyan-sheer-tarsier-951.mypinata.cloud/ipfs/QmWYcGTT3d12nuCZL3ZiCrSnz1vh6qs6V8Seg3LNgFVetf/"+encode[_tokenId];
    ...
    function transferFrom(address _from, address _to, uint256 _tokenId) external payable{
        require(_ownerOf[_tokenId]==_from,"REC721: invalid owner!");
        require(msg.sender==_from || msg.sender == _tokenApproval[_tokenId] || _operatorApproval[_from][msg.sender]==true,"ERC721: invalid sender!");
